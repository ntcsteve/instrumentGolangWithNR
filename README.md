...
The link to the Instruqt workshop is [here](https://play.instruqt.com/newrelic/invite/s5kyxbycvqqp). You can also see the sample code used for each app for reference.
